  ...
  <div style="background-color: #f0f0f0; overflow: hidden">
    ...
    >
        ...
        >
          ...
          >
            <a-space direction="vertical">
              <a-list
                style="margin-bottom: 25px; overflow-y: auto; width: 380px"
                :data="dataList"
                :hoverable="true"
                :pagination-props="{
                  bufferSize: 3,
      ...
      >
        <button
          @click="doRun"
          :class="{ runButton: true }"
          style="
            border-radius: 5px; /* 圆角半径为按钮高度的一半 */
            padding: 10px; /* 按钮内边距 */
          "
        >
        ...
        <template #first>
          ...
          >
            ...
            >
              ...
              <!-- 放大按钮 -->
              <div
                style="margin-top: auto; margin-left: -2px; margin-bottom: 2px"
              >
                    ...
                    <div style="margin-top: auto; margin-left: -2px">
                      <a-space :size="1" direction="vertical">
                        ...
                        >
                          ...
                          <button
                            @click="
                              layout_second_first_full_screen = true;
                              firstSize = 0.5;
                            "
                            style="
                              display: flex;
                    ...
                    >
                      <a-space :size="1" direction="vertical">
                        ...
                        >
                          ...
                          <button
                            @click="
                              layout_second_second_full_screen = true;
                              firstSize = 0.5;
                            "
                            style="
                              display: flex;
...
import IconCutOffRule from "@/views/calendar/icon/icon-cut-off-rule.vue";
import IconTestCase from "@/views/calendar/icon/icon-test-case.vue";
import IconTestResult from "@/views/calendar/icon/icon-test-result.vue";
import IconRun from "@/views/calendar/icon/icon-run.vue";
...
import IconSubmit from "@/views/calendar/icon/icon-submit.vue";
