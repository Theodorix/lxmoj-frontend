      ...
      <a-col :span="18">
        <div>
          ...
          <a-form :model="searchParams" layout="inline">
            <a-space :size="-25" style="display: flex; margin: 0 auto">
              <!-- 题单 -->
              <!--              <a-form-item>-->
              <!--                <a-button-->
              <!--                  style="-->
                          ...
                          >
                            <a-tag
                              ...
                              style="
                                ...
                                margin-bottom: 5px;
                              "
                              v-for="(tag, index) of basicTags.slice(
                                0,
                                basicTagsNum
                              )"
                              :key="index"
                              :color="
                                showTags.includes(tag) ? '#165dff' : 'gray'
                              "
                              @click="doTagCheck(tag)"
                            >
                              {{ tag }}
                          ...
                          >
                            <a-tag
                              ...
                              style="
                                ...
                                margin-bottom: 5px;
                              "
                              v-for="(tag, index) of algorithmTags.slice(
                                0,
                                algorithmTagsNum
                              )"
                              :key="index"
                        ...
                        >
                          ...
                          >
                            <a-tag
                              ...
                              v-for="(
                                tag, index
                              ) of advanced_Date_StructureTags.slice(
                                0,
                          ...
                          >
                            <a-tag
                              ...
                              style="
                                ...
                                margin-bottom: 5px;
                              "
                              v-for="(tag, index) of skillTags.slice(
                                0,
                                skillTagsNun
                              )"
                              :key="index"
                          ...
                          >
                            <a-tag
                              ...
                              style="
                                ...
                                margin-bottom: 5px;
                              "
                              v-for="(tag, index) of arithTags.slice(
                                0,
                                arithTagsNun
                              )"
                              :key="index"
                          ...
                          >
                            <a-tag
                              ...
                              style="
                                ...
                                margin-bottom: 5px;
                              "
                              v-for="(tag, index) of otherTags.slice(
                                0,
                                otherTagsNun
                              )"
                              :key="index"
                      ...
                      >
                        ...
                        <div style="color: #3c3c4399">
                          <icon-loop
                            ...
                            @click="resettingTags"
                          />
                          <span style="cursor: pointer" @click="resettingTags"
                            >重置</span
                          >
                        </div>
                      </div>
            ...
            <a-space direction="vertical">
              ...
              >
                ...
                <div style="width: 298px; display: flex">
                  ...
                  >
                    <span style="margin-right: 6px">题目</span>
                ...
                <div style="width: 180px; display: flex">
                  <button
                    ...
                    style="justify-content: center"
                  >
                    <span style="margin-right: 6px">通过率</span>
                    <a-space direction="vertical" :size="-11">
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              />
                              <template #content>
                                <div class="Attempted-basic">未开始</div>
                              </template>
                            </a-trigger>
                          </div>
                          <!-- 题目 -->
        ...
        <!-- 分页组件 -->
        <div
          style="display: flex; justify-content: flex-end; margin-right: 36px"
        >
          <a-pagination
            :total="total"
            show-jumper
            ...
            >
              ...
              >
                <div
                  ...
                  @mouseover="
                    questionSubmitPassRateNumShow = true;
                    SubmissionPassRateNumShow = false;
                  "
                  @mouseleave="
                    questionSubmitPassRateNumShow = false;
                ...
                <div style="display: flex; gap: 15px; height: 68px">
                  ...
                  <div
                    style="width: 24px; cursor: pointer"
                    @mouseover="
                      mediumSubmissionPassRateNumShow = true;
                      SubmissionPassRateNumShow = false;
                    "
                    @mouseleave="
                      mediumSubmissionPassRateNumShow = false;
                      SubmissionPassRateNumShow = true;
                    "
                  >
...
const methods = {
  // Your methods here
  calculatePercentage(acceptedNum: number, submitNum: number) {
    if (submitNum === 0) {
      return 0;
    } else {
      return (acceptedNum / submitNum) * 100;
    }
  },
};
...
import IconPlayer from "@/views/calendar/icon/icon-player.vue";
...
const advanced_Date_StructureTags = [
  "并查集",
  "字典树",
  "线段树",
  "树状数组",
...
const loadData = async () => {
  ...
  // 获取不同难度的题目数量
  const difficultyRes =
    await QuestionControllerService.getQuestionDifficultyUsingGet();
  ...
  const briefnessPassRes =
    await QuestionSubmitControllerService.getQuestionSubmitDifficultyUsingGet(
      1
    );
  ...
  const briefnessSubmissionPassRateRes =
    await QuestionSubmitControllerService.getQuestionSubmitDifficultyPassRateUsingGet(
      1
    );
  if (briefnessSubmissionPassRateRes.code == 0) {
    briefnessSubmissionPassRateNum.value =
      briefnessSubmissionPassRateRes.data as number;
  }
  ...
  if (mediumSubmissionPassRateRes.code == 0) {
    mediumSubmissionPassRateNum.value =
      mediumSubmissionPassRateRes.data as number;
  }
  ...
  if (difficultySubmissionPassRateRes.code == 0) {
    difficultySubmissionPassRateNum.value =
      difficultySubmissionPassRateRes.data as number;
  }
  ...
  const throughSum = computed(() => {
    return (
      Number(briefnessPassNum.value) +
      Number(mediumPassNum.value) +
      Number(difficultyPassNum.value)
    );
  });
  ...
  const Sum = computed(() => {
    return (
      Number(briefnessNum.value) +
      Number(mediumNum.value) +
      Number(difficultyNum.value)
    );
  });
...
const statusMessages = async () => {
  const res =
    await QuestionSubmitControllerService.getQuestionSubmitStatusByUserUsingGet();
  if (res.code == 0) {
...
// const doStatus = (number: number) => {
//   if (statusTag.value != number) {
//     const passIds = questionPassIds.value || []; // 如果是null，则使用空数组
//     const notPassIds = questionNotPassIds.value || []; // 如果是null，则使用空数组
//
//     if (number === 1) {
//       searchParams.value = {
//         ...searchParams.value,
//         notContainIds: passIds.concat(notPassIds),
//       };
//     } else if (number === 2) {
//       searchParams.value = {
//         ...searchParams.value,
...
const doRandom = async () => {
  ...
  await router.push({
    path: `/view/question/${randomQuestionId}/description`,
  });
};
...
const selectTags = (value: string) => {
  if (value) {
    ...
    const filteredBasicTags = basicTags.filter((basicTag) =>
    ...
    const filteredDate_StructureTags = date_StructureTags.filter(
      (date_StructureTag) => date_StructureTag.includes(searchTerm)
    );
    const filteredAdvanced_Date_StructureTags =
      advanced_Date_StructureTags.filter((advanced_Date_StructureTag) =>
        advanced_Date_StructureTag.includes(searchTerm)
      );
    const filteredSkillTags = skillTags.filter((skillTag) =>
      skillTag.includes(searchTerm)
    );
    const filteredArithTags = arithTags.filter((arithTag) =>
      arithTag.includes(searchTerm)
    );
    const filteredOtherTags = otherTags.filter((otherTag) =>
